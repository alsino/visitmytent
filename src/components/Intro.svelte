...
<div style="background:{colorScheme.background}; color:{colorScheme.textDefault}">
  ...
  {#if introVisible}
    ...
    <div class="column" style="color:{colorScheme.textDefault}"> <em> visitmyorbit</em>  is a portal into the life of contemporary artists working in various fields. The site shows artists' motivations, studio locations as well as {links.length} connections among them – creating an inside view into the networks of {nodes.length} artists presented on <a href="https://visitmytent.com/" target="_blank">visitmytent</a>.</div>
      ...
      <div class="column" style="color:{colorScheme.textDefault}">Once you're curious about an artist, you can dive into the respective studio visit and interview. <em>visitmyorbit</em> is a visualization by <a href="https://stephanieneumann.com/" target="_blank">Stephanie Neumann</a> and <a href="https://visitmytent.com/?p=11325" target="_blank">Alsino Skowronnek</a> crafted in Berlin, 2020.</div>
    </div>
